...
class NumberOfResponsesApprovedTest extends TestCase
{

    /** @test */
    public function name_returns_a_string(){
        $condition = new NumberOfResponsesApproved('typeform');
    ...
    public function alias_returns_a_string(){
        $condition = new NumberOfResponsesApproved('typeform');
        $this->assertIsString($condition->name());
        $this->assertEquals('number_of_responses_approved', $condition->alias());
    }
    ...
    public function isComplete_returns_true_if_the_num_of_responses_is_greater_than_the_setting(){
        ...
        Response::factory()->count(5)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => true]);
        Response::factory()->count(2)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => false]);
    ...
    public function isComplete_returns_false_if_the_num_of_responses_is_less_than_the_setting(){
        ...
        Response::factory()->count(1)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => true]);
        Response::factory()->count(2)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => false]);
    ...
    public function percentage_returns_100_if_the_num_of_responses_is_greater_than_the_setting(){
        ...
        Response::factory()->count(6)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => true]);
