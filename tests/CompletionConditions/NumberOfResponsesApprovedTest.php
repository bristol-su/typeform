...
class NumberOfResponsesApprovedTest extends TestCase
{
    ...
    public function isComplete_returns_true_if_the_num_of_responses_is_greater_than_the_setting(){
        ...
        factory(Response::class, 5)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => true]);
        factory(Response::class, 2)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => false]);
    ...
    public function isComplete_returns_false_if_the_num_of_responses_is_less_than_the_setting(){
        ...
        factory(Response::class, 1)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => true]);
        factory(Response::class, 2)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => false]);
    ...
    public function percentage_returns_100_if_the_num_of_responses_is_greater_than_the_setting(){
        ...
        factory(Response::class, 6)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => true]);
