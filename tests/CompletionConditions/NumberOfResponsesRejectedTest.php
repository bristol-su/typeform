...
class NumberOfResponsesRejectedTest extends TestCase
{

    /** @test */
    public function name_returns_a_string(){
        $condition = new NumberOfResponsesRejected('typeform');
    ...
    public function alias_returns_a_string(){
        $condition = new NumberOfResponsesRejected('typeform');
        $this->assertIsString($condition->name());
        $this->assertEquals('number_of_responses_rejected', $condition->alias());
    }
    ...
    public function isComplete_returns_true_if_the_num_of_responses_is_equal_to_the_setting(){
        ...
        Response::factory()->count(2)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => false]);
        Response::factory()->count(2)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => true]);
    ...
    public function isComplete_returns_true_if_the_num_of_responses_is_greater_than_the_setting(){
        ...
        Response::factory()->count(5)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => false]);
        Response::factory()->count(2)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => true]);
    ...
    public function isComplete_returns_false_if_the_num_of_responses_is_less_than_the_setting(){
        ...
        Response::factory()->count(1)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => false]);
        Response::factory()->count(2)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => true]);
    ...
    public function percentage_returns_100_if_the_num_of_responses_is_greater_than_the_setting(){
        ...
        Response::factory()->count(6)->create(['activity_instance_id' => $activityInstance->id, 'module_instance_id' => $moduleInstance->id(), 'approved' => false]);
